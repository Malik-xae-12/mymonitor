          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {currentWorkspaceId && onOpenTableLogConfig && (
              <button
                ...
                title="Configure Lakehouse/Warehouse & Dynamic Column Mappings"
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-cyan-300 transition shadow-sm text-xs font-semibold"
              >
                <Database className="w-3.5 h-3.5 text-cyan-400" />
                <span className="hidden md:inline">Table Log Config</span>
              </button>
            )}
          </div>
        </div>
