...
class LeasedWorkspacePoller:
    ...
    async def sync_workspace_with_fabric(self, workspace_id: str, force_sync: bool = False) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # 4. Recursively fetch activity trees
            if force_sync:
            ...
            # 5. Dynamically update child vs parent pipeline roles
            await pipeline_repository.update_child_pipeline_flags(workspace_id, discovered_child_ids, discovered_child_names)
            ...
            latest_tree = await pipeline_repository.get_workspace_latest_tree(workspace_id)
            return latest_tree
